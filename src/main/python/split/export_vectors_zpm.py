...
print(gscript.read_command('v.in.ogr', flags="o", input=DATAOUTPUTPATH+'/cregion.geojson', output='cregion', overwrite=True))
...
def export_current(name):
    ...
    print(gscript.read_command('v.out.ogr', format='ESRI_Shapefile', input=name + '_cregion', output=DATAOUTPUTPATH +'/' + name.lower() + '.shp', overwrite=True))
